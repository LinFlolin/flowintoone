...
export default function HeroHome() {
  return (
    ...
    //     <FadeInOnScroll delay={500}  mobileVariant='zoom-in' desktopVariant='fade-up' >
    ...
    //       </p>
    //     </FadeInOnScroll>
    //     <FadeInOnScroll delay={500} variant="fade-up"  desktopVariant='fade-up'>
    ...
    //         <FadeInOnScroll delay={500}  mobileVariant='zoom-in'>
    ...
    //         <FadeInOnScroll delay={500}  mobileVariant='zoom-in' desktopVariant='none'>
    //           <h2 className="text-3xl my-6 text-right  ">Cresci insieme a noi</h2>
    //           <p className="text-xl mb-6 text-right ">
    //             Scopri nuove storie, prodotti unici e talenti nascosti , tutto in un solo luogo ”
    //           </p>
    //         </FadeInOnScroll>
    //         <FadeInOnScroll delay={500}  mobileVariant='zoom-in' desktopVariant='none' className="flex justify-center">
    ...
    // </div>
      ...
      <div className="bg-linear-to-b text-Cream z-20 from-[#7217ba] from-50% md:from-60% to-[#f8f4ec] md:via-20%  flex flex-col  justify-center items-center  md:h-150  ">
          <div className="max-w-7xl flex flex-col md:flex-row md:justify-around md:items-center" >
            <div className="max-md:bg-linear-to-b from-Viola/70 via-Viola-Light/90 to-Cream/10 flex flex-col items-start md:max-w-2/3 md:px-12 md:p-8 ">
              <FadeInOnScroll delay={500}  mobileVariant='zoom-in' desktopVariant='fade-up' >
                <h1 className="text-4xl my-6 md:text-4xl  md:mb-4 ">Flowintoone</h1>
                <h2 className="text-2xl my-6 md:text-2xl  md:mb-4 ">"Un’unica vetrina infinite realtà da scoprire</h2>
                <p className=" max-md:hidden text-xl mb-6">
                  Flow Into One è la piattaforma digitale che unisce e mette in contatto persone, artigiani, negozi, fornitori e freelance in un unico spazio online."
                </p>
                <p className="md:hidden text-xl mb-6 text-right ">
            ...
            <div className=" md:rounded-2xl md:flex md:items-center md:justify-center  "> 
              ...
              <video
                  ...
                  playsInline
                  preload="metadata"
                  className="w-full md:border-2 md:w-auto md:h-[400px] md:m-2 md:rounded-2xl md:p-2 shadow-[20px_-20px_1px_Orange]"
                >
                <source src="/hero_video.webm" type="video/webm" />
                  Il tuo browser non supporta il video.
              </video>
