...
export function RegistrationCTA() {
  return (
    <section className="px-5 pb-20 sm:px-8 sm:pb-28 lg:px-10" aria-labelledby="registration-heading">
      <div className="mx-auto grid max-w-[1500px] overflow-hidden rounded-[2rem] bg-heather px-6 py-12 sm:grid-cols-[1fr_auto] sm:items-center sm:gap-12 sm:rounded-[2.5rem] sm:px-12 sm:py-16">
